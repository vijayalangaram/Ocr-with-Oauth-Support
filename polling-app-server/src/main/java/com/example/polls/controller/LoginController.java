...
{		
	// followed by a oauth jwt acces token here below controller we have add additional registration for a springboot with mongo db user register for a ocr process  
